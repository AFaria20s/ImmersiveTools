...
**Author:** [AfonsoFaria20s](https://github.com/AfonsoFaria20s)  
**Repository:** [AfonsoFaria20s/ImmersiveTools](https://github.com/AfonsoFaria20s/ImmersiveTools)
...
2. Download the latest version of **Immersive Tools** from the [Releases](https://github.com/AfonsoFaria20s/ImmersiveTools/releases) page.
...
```bash
git clone [https://github.com/AfonsoFaria20s/ImmersiveTools.git](https://github.com/AfonsoFaria20s/ImmersiveTools.git)
cd ImmersiveTools
```
